...
## Project Structure
    ...
    ├── ravinderyadavcode__112485  # Django project configurations
...
1. Clone this repo and `cd ravinderyadavcode__112485`
...
2. Clone this repo and `cd ravinderyadavcode__112485`
